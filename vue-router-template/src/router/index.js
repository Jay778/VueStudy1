					...
					children:[
						{
								//我的信息
								path: '/lib1',
								component: resolve => require(['../components/Lib1.vue'], resolve),
								meta: {
									title: '我的班课'
								}
							},
							{
								//用户信息
								path: '/lib2',
								component: resolve => require(['../components/Lib2.vue'], resolve),
								meta: {
									title: '加入的班课'
								}
							},
							{
								//账号安全
								path: '/lib3',
								component: resolve => require(['../components/Lib3.vue'], resolve),
								meta: {
									title: '管理'
								}
							}
